        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-1">{{$popularMovies['vote_average']}}</span>
                    <span class="mx-2">|</span>
                    <span>{{ $popularMovies['release_date'] }}</span>
                    <span class="mx-2">|</span>
                ...
                <div class="mt-12">
                    ...
                    <div class="flex mt-4">
                        @foreach ($popularMovies['credits']['crew'] as $crew)
                            @if ($loop->index < 4)
                            <div class="mr-8">
                                <div>{{ $crew['name'] }}</div>
                                    ...
                                    <div class="bg-gray-900 rounded">
                                        ...
                                        <div class="modal-body px-8 py-8">
                                            <div class="responsive-container overflow-hidden relative" style="padding-top: 50%">
                                                <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $popularMovies['videos']['results'][0]['key'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="movie-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach ($popularMovies['credits']['cast'] as $cast)
                @if ($loop->index<10)
                    <div class="mt-8">
                        <a href="#">
    ...
    <div class="movie-images">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($popularMovies['images']['backdrops'] as $image)
                    @if ($loop->index < 12)
                        <div class="mt-8">
